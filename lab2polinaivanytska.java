...
class Lab2 {
  ...
  public void queue() {
    ...
    System.out.println("Head of peek: " + q.peek());
  ...
  public void stack() {
    ...
    System.out.println("Empty stack?" + bookStack.empty());
